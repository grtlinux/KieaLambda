...
import org.tain.test.t01.sample13.Student;

public class PredicateTestMain {

	private static double avg(List<Student> list, Predicate<Student> predicate) {
		int sum = 0;
		int count = 0;
	...
	public static void main(String[] args) {
		...
		double avg;
		avg = avg(list, s -> s.getSex().equals("남자"));
		System.out.println("남자평균: " + avg);
		
		avg = avg(list, s -> s.getSex().equals("여자"));
